...
def generate_launch_description():
    ...
    ars_msf_state_estimator_node_name_arg = DeclareLaunchArgument(
        'ars_msf_state_estimator_node_name', default_value='ars_msf_state_estimator_node',
        description='Name of the node'
    )

    ars_msf_state_estimator_yaml_file_arg=DeclareLaunchArgument(
      'config_param_msf_state_estimator_yaml_file',
      default_value=PathJoinSubstitution(['config_msf_state_estimator.yaml']), 
    ...
    ars_msf_state_estimator_conf_yaml_file = PathJoinSubstitution([FindPackageShare('ars_msf_state_estimator'), 'config', LaunchConfiguration('config_param_msf_state_estimator_yaml_file')])
    

    # Define the nodes
    ars_msf_state_estimator_node = Node(
        package='ars_msf_state_estimator',
        executable='ars_msf_state_estimator_ros_node',
        name=LaunchConfiguration('ars_msf_state_estimator_node_name'),
        output=LaunchConfiguration('screen'),
        parameters=[{'config_param_msf_state_estimator_yaml_file': ars_msf_state_estimator_conf_yaml_file}],
        remappings=[
    ...
    return LaunchDescription([
        screen_arg,
        ars_msf_state_estimator_node_name_arg,
        ars_msf_state_estimator_yaml_file_arg,
